function Spawn(keys)
  ...
  Timers:CreateTimer(.1, function()
	...
	Timers:CreateTimer(2, function()
		local TrailParticleName = "particles/econ/courier/courier_babyroshan_ti9/courier_babyroshan_ti9_ambient.vpcf"
	...
	Windrun = thisEntity:FindAbilityByName("windranger_windrun_lua")
...
function thisEntity:AIThink()
  ...
  if Windrun ~= nil and Windrun:IsFullyCastable() and self:GetHealthPercent() <= 90 then
	CastWindrun()
  elseif Windrun ~= nil and Windrun:IsFullyCastable() and self:GetHealthPercent() <= 25 then
    CastWindrun()
  end
