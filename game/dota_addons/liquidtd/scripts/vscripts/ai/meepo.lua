function Spawn( entityKeyValues )
    ...
    EarthBind = thisEntity:FindAbilityByName("meepo_earthbind")
...
function MeepoThink()
	...
	if thisEntity:GetAttackTarget() == nil and not EarthBind:IsFullyCastable() and not thisEntity:IsChanneling() then
...
function CastEarthBind()
	...
	Timers:CreateTimer(0.6, function()	
		ExecuteOrderFromTable({
			...
			AbilityIndex = EarthBind:entindex(),
		})
		end)
	end
end