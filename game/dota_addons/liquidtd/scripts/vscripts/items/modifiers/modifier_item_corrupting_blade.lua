...
function modifier_item_corrupting_blade:GetModifierAttackSpeedBonus_Constant( params )
...
function modifier_item_corrupting_blade:GetModifierProjectileName( params )
	if IsServer() then
		return "particles/item_effects/violet_blade.vpcf"
	end
end