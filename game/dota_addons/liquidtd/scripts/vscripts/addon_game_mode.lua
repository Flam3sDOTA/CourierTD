...
-- Particles
	...
	PrecacheResource( "particle", "particles/tower_effects/tower_windrunner_base_attack.vpcf", context )
	PrecacheResource( "particle", "particles/tower_effects/tower_mirana_base_attack.vpcf", context )
...
function LiquidTD:InitGameMode()
	...
	GameRules:SetStartingGold(185) -- default 185
