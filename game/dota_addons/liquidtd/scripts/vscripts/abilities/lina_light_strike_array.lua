...
LinkLuaModifier( "modifier_generic_stunned_lua", "abilities/modifiers/modifier_generic_stunned_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lina_light_strike_array_lua", "abilities/modifiers/modifier_lina_light_strike_array_lua", LUA_MODIFIER_MOTION_NONE )
