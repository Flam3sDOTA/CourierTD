...
LinkLuaModifier( "modifier_underlord_pit_of_malice_lua", "abilities/modifiers/modifier_underlord_pit_of_malice_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_underlord_pit_of_malice_lua_cooldown", "abilities/modifiers/modifier_underlord_pit_of_malice_lua_cooldown", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_underlord_pit_of_malice_lua_thinker", "abilities/modifiers/modifier_underlord_pit_of_malice_lua_thinker", LUA_MODIFIER_MOTION_NONE )
