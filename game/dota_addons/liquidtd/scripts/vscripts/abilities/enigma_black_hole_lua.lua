...
LinkLuaModifier( "modifier_enigma_black_hole_lua_thinker", "abilities/modifiers/modifier_enigma_black_hole_lua_thinker", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_enigma_black_hole_lua_debuff", "abilities/modifiers/modifier_enigma_black_hole_lua_debuff", LUA_MODIFIER_MOTION_HORIZONTAL )
