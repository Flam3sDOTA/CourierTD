...
LinkLuaModifier( "modifier_faceless_void_chronosphere_lua_thinker", "abilities/modifiers/modifier_faceless_void_chronosphere_lua_thinker", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_faceless_void_chronosphere_lua_effect", "abilities/modifiers/modifier_faceless_void_chronosphere_lua_effect", LUA_MODIFIER_MOTION_NONE )
